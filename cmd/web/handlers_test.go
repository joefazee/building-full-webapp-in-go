...
func TestIntegrationShowSnippet(t *testing.T) {
	app := newTestApplication(t)
...
func TestIntegrationSignupUser(t *testing.T) {
...
func TestIntegrationCreateSnippetForm(t *testing.T) {
	app := newTestApplication(t)
	ts := newTestServer(t, app.routes())
	defer ts.Close()
	...
	t.Run("Unauthenticated", func(t *testing.T) {
		...
		if !strings.HasPrefix(headers.Get("Location"), "/user/login") {
